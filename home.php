 ...
 <div class="row">
            <div class="col-md-4">
                <img width="100%" src="img/school_seal_100x100.pn">
            </div>
            <!-- Contact Details Column -->
            <div class="col-md-8">
                <h3>Contact Details</h3>
                <p>
                    Holy Trinity Academy of Loay 
                <br>Poblacion Ubos Loay Bohol<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (083) 228-9722</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="mailto:name@example.com">Admission@HTA.com</a>
                </p>
                            ...
                            <p>
                               <h1> VISION</h1>
                                   ...
                                   <ul>
                                    ...
                                    <li>Collectively strive and sustain the establishment of Holy Trinity Academy of Loay as a world-class institution from good to great and built to last.</li>
                                   </ul>
                                </p>
                        </div>
                        <!-- /.panel-body -->
